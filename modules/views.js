...
const botName = config.SLACK_CONFIG.name
...
module.exports = {
    ...
    helpByChannel: function (integrations, channel) {
        return display_help_by_channel(integrations, channel)
    },
    json: function (json) {
    ...
    smart: function (input) {
        return create_view_smart(input)
    },
...
// Primary
//****************************/
const display_help_by_channel = function (integrations, channel) {
    ...
    try {
        ...
        bot.postMessageToChannel(channel, 'Here is what I can do: ', params)
        return true
    } catch (e) {
        //
        throw e
...
const display_smart = async function (input) {
    ...
    try {
        ...
        bot.postMessageToChannel(defaultChannelName, 'output: ', params)
        return true
    } catch (e) {
...
//                 text = text+"\n "+property+":  "+"https://shapeshift.io/#/status/"+json[property]
//             }elseif(){
//                 text = text + "\n "+property+":  "+json[property]
//             }
//         }
